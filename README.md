...
1.9.0의 변경 사항과 검증 절차는 [릴리스 노트](docs/releases/1.9.0-release-notes.md)와 [검증 문서](docs/releases/1.9.0-validation.md)에서 확인할 수 있습니다. 이전 [1.8.4](docs/releases/1.8.4-release-notes.md), [1.8.3](docs/releases/1.8.3-release-notes.md), [1.8.2](docs/releases/1.8.2-release-notes.md) 기록도 보존합니다.
