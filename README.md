...
2.0.0의 변경 사항은 [릴리스 노트](docs/releases/2.0.0-release-notes.md)에서 확인할 수 있습니다. 이전 [1.9.2](docs/releases/1.9.2-release-notes.md), [1.9.0](docs/releases/1.9.0-release-notes.md) 기록도 보존합니다.
