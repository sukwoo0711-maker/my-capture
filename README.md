...
출시 준비 중인 1.8.0의 변경 사항과 검증 절차는 [릴리스 노트](docs/releases/1.8.0-release-notes.md)와 [검증 문서](docs/releases/1.8.0-validation.md)에서 확인할 수 있습니다. 이전 1.7.1 기록은 [릴리스 노트](docs/releases/1.7.1-release-notes.md)와 [검증 기록](docs/releases/1.7.1-validation.md)에 남아 있습니다.
