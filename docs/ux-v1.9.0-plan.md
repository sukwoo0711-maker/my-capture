...
- In progress: shell integrated; library and media writers continue in exclusive worktrees. The library writer currently owns the native-window/OLE fixture lease; media released its lease while correcting review findings.
